...
Generated on: Sen Jul 7 20:14:05 2025
...
- Each file is named with format: {component_name}_{type}_{index}_{original_filename}
...
def get_5g_config_path(component_name, component_type, index=1):
    """Get path to 5G configuration file for a component."""
    script_dir = os.path.dirname(os.path.abspath(__file__))
    configs_dir = os.path.join(script_dir, "5g-configs")
    
    # Look for config files matching the pattern
    import glob
    pattern = f"{component_name}_{component_type}_{index}_*.yaml"
    pattern_yml = f"{component_name}_{component_type}_{index}_*.yml"
    
    matches = glob.glob(os.path.join(configs_dir, pattern))
    matches.extend(glob.glob(os.path.join(configs_dir, pattern_yml)))
    
    if matches:
        return matches[0]
    else:
        # Return expected path even if file doesn't exist
        return os.path.join(configs_dir, f"{component_name}_{component_type}_{index}_config.yaml")
...
def topology(args):
    ...
    info("*** Add UPF\n")
    upf1 = net.addStation('upf1', cap_add=["net_admin"], network_mode=NETWORK_MODE, privileged=True, publish_all_ports=True, dcmd="/bin/bash", cls=DockerSta, dimage='adaptive/open5gs:1.0', position='-612.5,-714.3,0', range=116, volumes=[export_dir + "/5g-configs/upf.yaml:/opt/open5gs/etc/open5gs/upf.yaml"], environment=["DB_URI=mongodb://netflux5g-mongodb/open5gs", "ENABLE_NAT=true", "NETWORK_INTERFACE=eth0", "OVS_ENABLED=true", "OVS_CONTROLLER=netflux5g-ryu-controller", "OVS_BRIDGE_NAME=br-open5gs", "OVS_FAIL_MODE=standalone", "OPENFLOW_PROTOCOLS=OpenFlow14", "OVS_DATAPATH=kernel", "CONTROLLER_PORT=6633", "BRIDGE_PRIORITY=32768", "STP_ENABLED=true"])
    upf2 = net.addStation('upf2', cap_add=["net_admin"], network_mode=NETWORK_MODE, privileged=True, publish_all_ports=True, dcmd="/bin/bash", cls=DockerSta, dimage='adaptive/open5gs:1.0', position='-612.5,-714.3,0', range=116, volumes=[export_dir + "/5g-configs/upf2.yaml:/opt/open5gs/etc/open5gs/upf.yaml"], environment=["DB_URI=mongodb://netflux5g-mongodb/open5gs", "ENABLE_NAT=true", "NETWORK_INTERFACE=eth0", "OVS_ENABLED=true", "OVS_CONTROLLER=netflux5g-ryu-controller", "OVS_BRIDGE_NAME=br-open5gs", "OVS_FAIL_MODE=standalone", "OPENFLOW_PROTOCOLS=OpenFlow14", "OVS_DATAPATH=kernel", "CONTROLLER_PORT=6633", "BRIDGE_PRIORITY=32768", "STP_ENABLED=true"])
    info("*** Add AMF\n")
    amf1 = net.addStation('amf1', cap_add=["net_admin"], network_mode=NETWORK_MODE, publish_all_ports=True, dcmd="/bin/bash", cls=DockerSta, dimage='adaptive/open5gs:1.0', position='-612.5,-714.3,0', range=116, volumes=[export_dir + "/5g-configs/amf.yaml:/opt/open5gs/etc/open5gs/amf.yaml"], environment=["DB_URI=mongodb://netflux5g-mongodb/open5gs", "NETWORK_INTERFACE=eth0", "MCC=999", "MNC=70", "TAC=1", "SST=1", "SD=0xffffff"])
    info("*** Add SMF\n")
    smf1 = net.addStation('smf1', cap_add=["net_admin"], network_mode=NETWORK_MODE, publish_all_ports=True, dcmd="/bin/bash", cls=DockerSta, dimage='adaptive/open5gs:1.0', position='-612.5,-714.3,0', range=116, volumes=[export_dir + "/5g-configs/smf.yaml:/opt/open5gs/etc/open5gs/smf.yaml"], environment=["DB_URI=mongodb://netflux5g-mongodb/open5gs", "NETWORK_INTERFACE=eth0"])
    info("*** Add NRF\n")
    nrf1 = net.addStation('nrf1', cap_add=["net_admin"], network_mode=NETWORK_MODE, publish_all_ports=True, dcmd="/bin/bash", cls=DockerSta, dimage='adaptive/open5gs:1.0', position='-612.5,-714.3,0', range=116, volumes=[export_dir + "/5g-configs/nrf.yaml:/opt/open5gs/etc/open5gs/nrf.yaml"], environment=["DB_URI=mongodb://netflux5g-mongodb/open5gs", "NETWORK_INTERFACE=eth0"])
    info("*** Add SCP\n")
    scp1 = net.addStation('scp1', cap_add=["net_admin"], network_mode=NETWORK_MODE, publish_all_ports=True, dcmd="/bin/bash", cls=DockerSta, dimage='adaptive/open5gs:1.0', position='-612.5,-714.3,0', range=116, volumes=[export_dir + "/5g-configs/scp.yaml:/opt/open5gs/etc/open5gs/scp.yaml"], environment=["DB_URI=mongodb://netflux5g-mongodb/open5gs", "NETWORK_INTERFACE=eth0"])
    info("*** Add AUSF\n")
    ausf1 = net.addStation('ausf1', cap_add=["net_admin"], network_mode=NETWORK_MODE, publish_all_ports=True, dcmd="/bin/bash", cls=DockerSta, dimage='adaptive/open5gs:1.0', position='-612.5,-714.3,0', range=116, volumes=[export_dir + "/5g-configs/ausf.yaml:/opt/open5gs/etc/open5gs/ausf.yaml"], environment=["DB_URI=mongodb://netflux5g-mongodb/open5gs", "NETWORK_INTERFACE=eth0"])
    info("*** Add BSF\n")
    bsf1 = net.addStation('bsf1', cap_add=["net_admin"], network_mode=NETWORK_MODE, publish_all_ports=True, dcmd="/bin/bash", cls=DockerSta, dimage='adaptive/open5gs:1.0', position='-612.5,-714.3,0', range=116, volumes=[export_dir + "/5g-configs/bsf.yaml:/opt/open5gs/etc/open5gs/bsf.yaml"], environment=["DB_URI=mongodb://netflux5g-mongodb/open5gs", "NETWORK_INTERFACE=eth0"])
    info("*** Add NSSF\n")
    nssf1 = net.addStation('nssf1', cap_add=["net_admin"], network_mode=NETWORK_MODE, publish_all_ports=True, dcmd="/bin/bash", cls=DockerSta, dimage='adaptive/open5gs:1.0', position='-612.5,-714.3,0', range=116, volumes=[export_dir + "/5g-configs/nssf.yaml:/opt/open5gs/etc/open5gs/nssf.yaml"], environment=["DB_URI=mongodb://netflux5g-mongodb/open5gs", "NETWORK_INTERFACE=eth0"])
    info("*** Add PCF\n")
    pcf1 = net.addStation('pcf1', cap_add=["net_admin"], network_mode=NETWORK_MODE, publish_all_ports=True, dcmd="/bin/bash", cls=DockerSta, dimage='adaptive/open5gs:1.0', position='-612.5,-714.3,0', range=116, volumes=[export_dir + "/5g-configs/pcf.yaml:/opt/open5gs/etc/open5gs/pcf.yaml"], environment=["DB_URI=mongodb://netflux5g-mongodb/open5gs", "NETWORK_INTERFACE=eth0"])
    info("*** Add UDM\n")
    udm1 = net.addStation('udm1', cap_add=["net_admin"], network_mode=NETWORK_MODE, publish_all_ports=True, dcmd="/bin/bash", cls=DockerSta, dimage='adaptive/open5gs:1.0', position='-612.5,-714.3,0', range=116, volumes=[export_dir + "/5g-configs/udm.yaml:/opt/open5gs/etc/open5gs/udm.yaml"], environment=["DB_URI=mongodb://netflux5g-mongodb/open5gs", "NETWORK_INTERFACE=eth0"])
    info("*** Add UDR\n")
    udr1 = net.addStation('udr1', cap_add=["net_admin"], network_mode=NETWORK_MODE, publish_all_ports=True, dcmd="/bin/bash", cls=DockerSta, dimage='adaptive/open5gs:1.0', position='-612.5,-714.3,0', range=116, volumes=[export_dir + "/5g-configs/udr.yaml:/opt/open5gs/etc/open5gs/udr.yaml"], environment=["DB_URI=mongodb://netflux5g-mongodb/open5gs", "NETWORK_INTERFACE=eth0"])

    info("*** Add gNB\n")
    GNB__1 = net.addStation('GNB__1', cap_add=["net_admin"], network_mode=NETWORK_MODE, publish_all_ports=True, dcmd="/bin/bash", cls=DockerSta, dimage='adaptive/ueransim:latest', privileged=True, volumes=["/sys:/sys", "/lib/modules:/lib/modules", "/sys/kernel/debug:/sys/kernel/debug"], position='-428.3,-23.8,0', range=300, txpower=25.0, environment={"AMF_IP": "amf1", "GNB_HOSTNAME": "gnb1", "N2_IFACE": "eth0", "N3_IFACE": "eth0", "RADIO_IFACE": "eth0", "MCC": "999", "MNC": "70", "SST": "1", "SD": "0xffffff", "TAC": "1", "AP_ENABLED": "true", "AP_SSID": "gnb-hotspot1", "AP_CHANNEL": "6", "AP_MODE": "n", "AP_PASSWD": "", "AP_BRIDGE_NAME": "br-gnb", "OVS_CONTROLLER": "tcp:netflux5g-ryu-controller:6633", "AP_FAILMODE": "standalone", "OPENFLOW_PROTOCOLS": "OpenFlow14", "AP_DATAPATH": "kernel"})
    GNB__2 = net.addStation('GNB__2', cap_add=["net_admin"], network_mode=NETWORK_MODE, publish_all_ports=True, dcmd="/bin/bash", cls=DockerSta, dimage='adaptive/ueransim:latest', privileged=True, volumes=["/sys:/sys", "/lib/modules:/lib/modules", "/sys/kernel/debug:/sys/kernel/debug"], position='298.7,-50.3,0', range=300, txpower=25.0, environment={"AMF_IP": "amf1", "GNB_HOSTNAME": "gnb2", "N2_IFACE": "eth0", "N3_IFACE": "eth0", "RADIO_IFACE": "eth0", "MCC": "999", "MNC": "70", "SST": "1", "SD": "0xffffff", "TAC": "1", "AP_ENABLED": "true", "AP_SSID": "gnb-hotspot2", "AP_CHANNEL": "6", "AP_MODE": "n", "AP_PASSWD": "", "AP_BRIDGE_NAME": "br-gnb2", "OVS_CONTROLLER": "tcp:netflux5g-ryu-controller:6633", "AP_FAILMODE": "standalone", "OPENFLOW_PROTOCOLS": "OpenFlow14", "AP_DATAPATH": "kernel"})

    info("*** Adding docker UE hosts\n")
    UE__8 = net.addStation('UE__8', devices=["/dev/net/tun"], cap_add=["net_admin"], range=100.0, txpower=20.0, network_mode=NETWORK_MODE, dcmd="/bin/bash", cls=DockerSta, dimage='gradiant/ueransim:3.2.6', position='428.5,36.2,0', environment={"GNB_HOSTNAME": "gnb2", "APN": "internet2", "MSISDN": "0000000014", "MCC": "999", "MNC": "70", "SST": "1", "SD": "0xffffff", "TAC": "1", "KEY": "465B5CE8B199B49FAA5F0A2EE238A6BC", "OP_TYPE": "OPC", "OP": "E8ED289DEBA952E4283B54E88E6183CA", "IMEI": "356938035643803", "IMEISV": "4370816125816151", "TUNNEL_IFACE": "uesimtun0", "RADIO_IFACE": "eth0", "SESSION_TYPE": "IPv4", "PDU_SESSIONS": "1", "MOBILITY_ENABLED": "false"})
    ...
    # Finding best access point for UE__8 at position (428.5, 36.2)
    # GNB #1 (GNB) at (-428.3, -23.8): distance=858.9m, range=300m
    # GNB #2 (GNB) at (298.7, -50.3): distance=155.9m, range=300m
    # UE__8 -> GNB #2 (SSID: gnb-hotspot2, distance: 155.9m)
    # Finding best access point for UE__7 at position (-253.8, -110.1)
    # GNB #1 (GNB) at (-428.3, -23.8): distance=194.7m, range=300m
    # GNB #2 (GNB) at (298.7, -50.3): distance=555.7m, range=300m
    # UE__7 -> GNB #1 (SSID: gnb-hotspot1, distance: 194.7m)
    # Finding best access point for UE__6 at position (217.6, 74.7)
    # GNB #1 (GNB) at (-428.3, -23.8): distance=653.4m, range=300m
    # GNB #2 (GNB) at (298.7, -50.3): distance=149.0m, range=300m
    # UE__6 -> GNB #2 (SSID: gnb-hotspot2, distance: 149.0m)
    # Finding best access point for UE__5 at position (261.4, -205.5)
    # GNB #1 (GNB) at (-428.3, -23.8): distance=713.3m, range=300m
    # GNB #2 (GNB) at (298.7, -50.3): distance=159.6m, range=300m
    # UE__5 -> GNB #2 (SSID: gnb-hotspot2, distance: 159.6m)
    # Finding best access point for UE__4 at position (68.4, -62.0)
    # GNB #1 (GNB) at (-428.3, -23.8): distance=498.2m, range=300m
    # GNB #2 (GNB) at (298.7, -50.3): distance=230.6m, range=300m
    # UE__4 -> GNB #2 (SSID: gnb-hotspot2, distance: 230.6m)
    # Finding best access point for UE__3 at position (-319.1, 93.5)
    # GNB #1 (GNB) at (-428.3, -23.8): distance=160.3m, range=300m
    # GNB #2 (GNB) at (298.7, -50.3): distance=634.3m, range=300m
    # UE__3 -> GNB #1 (SSID: gnb-hotspot1, distance: 160.3m)
    # Finding best access point for UE__2 at position (-545.7, 65.9)
    # GNB #1 (GNB) at (-428.3, -23.8): distance=147.8m, range=300m
    # GNB #2 (GNB) at (298.7, -50.3): distance=852.4m, range=300m
    # UE__2 -> GNB #1 (SSID: gnb-hotspot1, distance: 147.8m)
    # Finding best access point for UE__1 at position (-647.8, -104.3)
    # GNB #1 (GNB) at (-428.3, -23.8): distance=233.8m, range=300m
    # GNB #2 (GNB) at (298.7, -50.3): distance=948.1m, range=300m
    # UE__1 -> GNB #1 (SSID: gnb-hotspot1, distance: 233.8m)
